...
namespace VoxelBusters.EssentialKit
{
    internal static class Constants
    {
        ...
        // product information
        public const string kProductDisplayName                         = "Cross Platform Essential Kit - LITE";

        public const string kProductVersion                             = "Version 2.0.3";
         
        public const string kProductCopyrights                          = "Copyright © 2020 Voxel Busters Interactive LLP.";
