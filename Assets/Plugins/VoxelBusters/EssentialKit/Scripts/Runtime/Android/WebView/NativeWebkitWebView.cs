...
namespace VoxelBusters.EssentialKit.WebViewCore.Android
{
    public class NativeWebkitWebView : NativeAndroidJavaObjectWrapper
    {
        ...
        public void UpdateBaseContext(NativeContext context)
        {
#if NATIVE_PLUGINS_DEBUG_ENABLED
            DebugLogger.Log("[Class : NativeWebkitWebView][Method : UpdateBaseContext]");
#endif
            Call(Native.Method.kUpdateBaseContext, context.NativeObject);
        }
        ...
        internal class Native
        {
            ...
            internal class Method
            {
                ...
                internal const string kUpdateBaseContext = "updateBaseContext";
