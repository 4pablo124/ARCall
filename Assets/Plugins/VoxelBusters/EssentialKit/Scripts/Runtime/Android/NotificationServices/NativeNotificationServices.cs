...
namespace VoxelBusters.EssentialKit.NotificationServicesCore.Android
{
    public class NativeNotificationServices : NativeAndroidJavaObjectWrapper
    {
        ...
        public void DispatchPendingLaunchNotifications(NativeNotificationReceivedListener listener)
        {
#if NATIVE_PLUGINS_DEBUG_ENABLED
            DebugLogger.Log("[Class : NativeNotificationServices][Method : DispatchPendingLaunchNotifications]");
#endif
            Call(Native.Method.kDispatchPendingLaunchNotifications, listener);
        }
        ...
        internal class Native
        {
            ...
            internal class Method
            {
                ...
                internal const string kDispatchPendingLaunchNotifications = "dispatchPendingLaunchNotifications";
