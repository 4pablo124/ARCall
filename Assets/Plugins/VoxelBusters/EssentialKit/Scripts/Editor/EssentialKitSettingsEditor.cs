...
namespace VoxelBusters.EssentialKit.Editor
{
    ...
    public class EssentialKitSettingsEditor : UnityEditor.Editor
    {
        #region Fields
        ...
        private void OnEnable()
        {
            ...
            {
                new PropertyGroupMeta() { displayName = "Application",              serializedPropertyName = "m_applicationSettings",           onAfterPropertyDraw = DrawApplicationSettingsControls, allowedInLiteVersion = true},
                new PropertyGroupMeta() { displayName = "Address Book",             serializedPropertyName = "m_addressBookSettings",           onAfterPropertyDraw = DrawAddressBookSettingsControls, allowedInLiteVersion = true },
                ...
                new PropertyGroupMeta() { displayName = "Network Services",         serializedPropertyName = "m_networkServicesSettings",       onAfterPropertyDraw = DrawNetworkServicesSettingsControls, allowedInLiteVersion = true },
                ...
                new PropertyGroupMeta() { displayName = "Sharing Services",         serializedPropertyName = "m_sharingServicesSettings",       onAfterPropertyDraw = DrawSharingServicesSettingsControls, allowedInLiteVersion = true },
                new PropertyGroupMeta() { displayName = "Native UI",                serializedPropertyName = "m_nativeUISettings",              onAfterPropertyDraw = DrawNativeUISettingsControls, allowedInLiteVersion = true },
        ...
        {
            if (!m_isFullVersion && !propertyMeta.allowedInLiteVersion)
            {
                return;
            }

            EditorGUILayout.BeginVertical(m_groupBackgroundStyle);
            if (DrawControlHeader(property, propertyMeta.displayName, propertyMeta.allowedInLiteVersion))
            {
        ...
        private bool DrawControlHeader(SerializedProperty property, string displayName, bool allowedInLiteVersion)
        {
            // draw rect
        ...
        private struct PropertyGroupMeta
        {
            ...
            public bool         allowedInLiteVersion;
        }
