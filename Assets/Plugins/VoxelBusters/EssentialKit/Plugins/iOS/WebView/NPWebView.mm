...
- (void)addConstraintsToSubViews
{
    ...
    [tabBar.heightAnchor constraintEqualToConstant:kTabBarHeight].active        = YES;
...
- (void)updateWebViewConstraints
{
    ...
    [webView.heightAnchor constraintEqualToAnchor:self.heightAnchor constant:bottomPadding].active   = YES;
}
