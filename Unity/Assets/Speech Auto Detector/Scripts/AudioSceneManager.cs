...
public class AudioSceneManager : MonoBehaviour
{
    ...
    {
        if (recorder != null)
            recorder.OnRecordingStart.AddListener(OnRecordingStart);
        if (player != null)
    ...
    {
        if (recorder != null)
            recorder.OnRecordingStart.RemoveListener(OnRecordingStart);
        if (player != null)
    ...
    private void OnRecordingStart(AudioClip clip)
    {
        _currentClip = clip;
        if (player != null)
