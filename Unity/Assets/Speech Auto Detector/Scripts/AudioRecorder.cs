...
public class AudioRecorder : MonoBehaviour
{
    ...
    public AudioRecorderClipEvent OnRecordingStart;
    public AudioRecorderEvent OnRecordingEnd;
    ...
    public bool StartRecording()
    {
        ...
        _sourceRecording.clip = Microphone.Start(_micName, true, timeForRecording, _frequency);
        while (Microphone.GetPosition(_micName) <= 0) { }
        _state = RecordingState.Sleep;
        _sourceRecording.Play();
        if (OnRecordingStart != null)
            OnRecordingStart.Invoke(_sourceRecording.clip);
        return true;
    }
